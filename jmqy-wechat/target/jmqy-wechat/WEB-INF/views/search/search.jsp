...
<div class="item1">
    ...
    <div class="item1-right"><input id='time' placeholder="起始时间"  type="text" name="boardingTime"
...
<div class="item1 shuang"style="display:none">
    ...
    <div class="item1-right"><input id='time1' placeholder="结束时间"  type="text" name="trackBoardTime"
