...
<form action="${ctx}/search/wechatsearCarTypes" id="myForm"  onsubmit="return check(this)" method="post">
    <input type="hidden" id="orderCode" name="orderCode" value="${order1.orderCode}"/>
    <input type="hidden" id="bigOrderCode" name="bigOrderCode" value="${order1.bigOrderCode}"/>
    <input type="hidden" id="viaPoint" name="viaPoint" value="${order1.viaPoint}"/>
    <input type="hidden" id="distance" name="distance" value="${order1.distance}">
    <input type="hidden" id="duration" name="duration" value="${order1.duration}">
    <input type="hidden" id="flag" name="flag" value="${order1.flag}">
    <input type="hidden" id="carCode" name="carCode" value="${order1.carCode}">
    <input type="hidden" id="amount" name="amount" value="">
    <input type="hidden" id="backOrderCode" name="backOrderCode" value="${order1.backOrderCode}">
    <input type="hidden" id="carTypes" name="carTypes" value="${order1.carTypes}">
    <input type="hidden" id="carAmounts" name="carAmounts" value="${order1.carAmounts}">
    <input type="hidden" id="prices" name="prices" value="${order1.prices}">
    ...
    <div class="item1">
        ...
        <div class="item1-right"><input id='time' placeholder="起始时间" type="text" id='time'  type="text" name="boardingTime"
                                        value="<fmt:formatDate type='date' pattern='yyyy-MM-dd HH:mm:ss' value='${order1.boardingTime}'/>"
        ></div>
    </div>
    <div class="item1 shuang"style="display:none">
        ...
        <div class="item1-right"><input id='time1' placeholder="结束时间" type="text" id='time1'  type="text" name="trackBoardTime"
                                        value="<fmt:formatDate type='date' pattern='yyyy-MM-dd HH:mm:ss' value='${order1.trackBoardTime}'/>"
        ></div>
    </div>
    <div class="item1">
