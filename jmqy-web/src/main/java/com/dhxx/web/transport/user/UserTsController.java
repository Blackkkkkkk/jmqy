package com.dhxx.web.transport.user;
...
public class UserTsController {
	
	private static Logger log = LoggerFactory.getLogger(UserTsController.class);
    ...
    public String saveOrUpdate(User user, Model model, RedirectAttributes redirectAttributes){
        ...
        return "redirect:/transport/user/form";
    }
