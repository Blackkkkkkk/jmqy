...
public class WeixinMpUtils {
	...
	//域名
	public final static String domain = "http://rent.easywalkie.com";
	
	//微信支付回调通知地址
	public final static String Notify_url = domain+"/charter/wechat/NativeNotifyUrl";
	//public final static String Notify_url = "http://n79unz.natappfree.cc/jmqy-web/charter/wechat/NativeNotifyUrl";
	
	//项目名
	public final static String project ="jmqy-web";
