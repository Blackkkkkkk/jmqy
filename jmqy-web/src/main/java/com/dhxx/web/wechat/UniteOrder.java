...
public class UniteOrder implements Serializable{
	...
	public static UniteOrder nativeUniteOrder(String out_trade_no, String body, String detail, String totalFee, String attach){
		UniteOrder order = new UniteOrder();
		order.setAppid(WeixinMpUtils.appID);
		order.setMch_id(WeixinMpUtils.mch_id);
		...
		order.setNotify_url(WeixinMpUtils.Notify_url);
		order.setTrade_type("NATIVE");  // 表示二维码支付
		String Product_id = PaymentTools.businessOrderNumber();
	...
	public static UniteOrder jsapiUniteOrder(String out_trade_no, String body, String detail, String totalFee, String openId, String mobile, String phone){
		UniteOrder order = new UniteOrder();
		order.setAppid(WeixinMpUtils.appID);
		order.setMch_id(WeixinMpUtils.mch_id);
		order.setDevice_info(PaymentTools.getServerIP());
		...
		order.setBody(body);
		order.setDetail(detail);
		order.setAttach(mobile+","+phone);
		order.setOut_trade_no(out_trade_no);
		order.setFee_type("CNY");
		order.setTotal_fee(totalFee);
		order.setSpbill_create_ip(PaymentTools.getServerIP());
		order.setNotify_url(PropertiesUtil.getHeadPath()+"/app/passenger/pay/wechat/notify_url");
