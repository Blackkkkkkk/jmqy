	...
	<section>
		...
		<jsp:include page="/WEB-INF/layouts/left_menu.jsp"/>
			...
			<div class="position_all">
				<div class="position">您所在的位置：首页 -> 个人中心 -> 额度查询</div>
			</div>
			<div class="info">
				<div class="searh searh1 integral">
					...
					<p><shiro:principal property="name"/>,您的信用额度为：<span class="orange">${credit.totalCredit}</span>元,已使用的额度为：<span class="orange">${credit.consumeCredit}</span>元,剩余的额度为：<span class="orange">${credit.stockCredit}</span>元</a>&nbsp;<a href="javascript:wechatPay('${credit.consumeCredit}');" class="layui-btn layui-btn-normal layui-btn-mini">结算</a></p>
