	...
	<form id="saveOrUpdate" class="layui-form" action="${ctx}/transport/car/saveOrUpdate" method="post" enctype="multipart/form-data">
		...
		<div class="layui-form-item">
			<div class="layui-inline">
				...
				<div class="layui-input-inline">
					<input name="carNum" lay-verify="required<c:if test='${empty car.id}'>|carNumUnique</c:if>" autocomplete="off" value="${car.carNum}" class="layui-input" type="text"
				...
				<div class="layui-input-inline">
					<select name="driverCode" lay-verify="required" lay-search="">
						...
						<c:forEach items="${drivers}" var="d" varStatus="status" >
							<option value="${d.code}" <c:if test="${d.code == car.driverCode}">selected = "selected"</c:if>>${d.name}</option>
						</c:forEach>
					</select>
				</div>
			</div>
		...
		<div class="layui-form-item">
			<div class="layui-inline">
				...
				<div class="layui-input-inline">
					<input name="carType1" id="carType1" autocomplete="off" value="${fn:substring(car.carType, 2, fn:length(car.carType)-1)}" class="layui-input" type="text"  lay-verify="required|number|carTypeFilter" onchange="chan();">
					<!--
				...
				<div class="layui-input-inline">
					<input id="seatNumber" name="seatNumber" value="${car.seatNumber}" lay-verify="required|lowerThan" autocomplete="off" class="layui-input" type="tel" >
				</div>
			</div>
		</div>
		<div class="layui-form-item">
				...
				<div class="layui-input-inline">
					...
					<div class="upload">
						...
						<i class="icon-cloud-upload" style="cursor:pointer;">
							<input id="drivingLicensePros" name="drivingLicensePros" type="hidden" value="${car.drivingLicensePros}"/>
							<input type="file" class="upload-button" id="drivingLicenseProsFile" name="drivingLicenseProsFile" onchange="previewImg(this);"/>
						</i>
					</div>
					<img class="img-mini zheng_a" src="
					...
					<div class="upload">
						...
						<i class="icon-cloud-upload" style="cursor:pointer;">
							<input id="drivingLicenseCons" name="drivingLicenseCons" type="hidden" value="${car.drivingLicenseCons}"/>
							<input type="file" class="upload-button" id="drivingLicenseConsFile" name="drivingLicenseConsFile" onchange="previewImg(this);"/>
						</i>
					</div>
				</div>
			</div>
			...
			<div class="layui-inline">
				...
				<div class="layui-input-inline">
					...
					<div class="upload">
						...
						<i class="icon-cloud-upload" style="cursor:pointer;">
							<input id="operationLicense" name="operationLicense" type="hidden" value="${car.operationLicense}"/>
							<input type="file" class="upload-button" id="operationLicenseFile" name="operationLicenseFile" onchange="previewImg(this);"/>
						</i>
					</div>
				</div>
			</div>
				...
				<div class="layui-input-inline" style="width: 100px;">
					...
					<div class="upload">
						...
						<i class="icon-cloud-upload" style="cursor:pointer;">
							...
							<input type="file" class="upload-button" id="xianlupaiProsFile" name="xianlupaiProsFile" onchange="previewImg(this);"/>
						</i>
					</div>
					</div>
					<div class="layui-input-inline" style="width: 100px;">
					...
					<div class="upload">
						...
						<i class="icon-cloud-upload" style="cursor:pointer;">
							...
							<input type="file" class="upload-button" id="xianlupaiConsFile" name="xianlupaiConsFile" onchange="previewImg(this);"/>
						</i>
					</div>
				</div>
			</div>
				...
				<div class="layui-input-inline" style="width: 100px;">
					...
					<div class="upload">
						...
						<i class="icon-cloud-upload" style="cursor:pointer;">
							...
							<input type="file" class="upload-button" id="carPhotoFile" name="carPhotoFile" onchange="previewImg(this);"/>
						</i>
					</div>
				</div>
				<div class="layui-input-inline" style="width: 100px;">
					...
					<div class="upload">
						...
						<i class="icon-cloud-upload" style="cursor:pointer;">
							...
							<input type="file" class="upload-button" id="carPhoto1File" name="carPhoto1File" onchange="previewImg(this);"/>
						</i>
					</div>
				</div>
				<div class="layui-input-inline" style="width: 100px;">
					...
					<div class="upload">
						...
						<i class="icon-cloud-upload" style="cursor:pointer;">
							...
							<input type="file" class="upload-button" id="carPhoto2File" name="carPhoto2File" onchange="previewImg(this);"/>
						</i>
					</div>
				</div>
				<div class="layui-input-inline" style="width: 100px;">
					...
					<div class="upload">
						...
						<i class="icon-cloud-upload" style="cursor:pointer;">
							...
							<input type="file" class="upload-button" id="carPhoto3File" name="carPhoto3File" onchange="previewImg(this);"/>
						</i>
					</div>
				</div>
			</div>
				...
				<div class="layui-input-inline" style="width: 100px;">
					...
					<div class="upload">
						...
						<i class="icon-cloud-upload" style="cursor:pointer;">
							...
							<input type="file" class="upload-button" id="carPhoto4File" name="carPhoto4File" onchange="previewImg(this);"/>
						</i>
					</div>
				</div>
				<div class="layui-input-inline" style="width: 100px;">
					...
					<div class="upload">
						...
						<i class="icon-cloud-upload" style="cursor:pointer;">
							...
							<input type="file" class="upload-button" id="carPhoto5File" name="carPhoto5File" onchange="previewImg(this);"/>
						</i>
					</div>
				</div>
			</div>
				...
				<div class="layui-input-inline">
					...
					<div class="upload">
						...
						<i class="icon-cloud-upload" style="cursor:pointer;">
							...
							<input type="file" class="upload-button" id="policyFile" name="policyFile" onchange="previewImg(this);"/>
						</i>
					</div>
				</div>
			</div>
		...
		<div class="layui-form-item">
			<div class="layui-inline">
				...
				<div class="layui-input-inline" style="width: 100px;">      
					<input type="text" name="madeDate" id="madeDate"  placeholder="出厂日期" autocomplete="off" lay-verify="required" class="layui-input input_date"
					onfocus="WdatePicker({dateFmt:'yyyy-MM-dd'})"
					value="<fmt:formatDate type='date' pattern='yyyy-MM-dd' value='${car.madeDate}'/>"> 
				</div>
				<label class="layui-form-label">停场地点:</label>
				<div class="layui-input-inline">
					<input id="site" name="site"  autocomplete="off" value="${car.site}" class="layui-input"  lay-verify="required" type="text" readonly onclick="showMap();" placeholder="点击在地图选点" style="cursor: pointer;"/>
