...
<div class="layui-form" style="margin-top: 10px;">
	<form id="saveOrUpdate" class="layui-form" action="${ctx}/transport/driver/saveOrUpdate" method="post" enctype="multipart/form-data">
		...
		<div class="layui-form-item">
			<div class="layui-inline">
				...
				<div class="layui-input-inline">
					<input name="name" lay-verify="required" autocomplete="off" value="${driver.name}" placeholder="姓名" class="layui-input" type="text" style="border:none; " disabled= "true">
				</div>
		...
		<div class="layui-form-item" pane="">
		    ...
		    <div class="layui-input-block">
			    <input   name="sex" value="男" title="男" <c:if test="${empty driver.sex || driver.sex == '男'}">checked="checked"</c:if> type="radio">
			    <input  name="sex" value="女" title="女" <c:if test="${driver.sex == '女'}">checked="checked"</c:if> type="radio">
		    </div>
	  	</div>
	  	<div class="layui-form-item">
			<div class="layui-inline">
				...
				<div class="layui-input-inline" style="width: 50px;">
					<input name="jobNum" autocomplete="off" value="${company.jobNumPre}" class="layui-input" type="text" disabled />
				</div>
				<div class="layui-input-inline" style="width: 130px;">
					<input style="border:none; " disabled= "true" name="jobNum" lay-verify="required|number|jobNumUnique" placeholder="4位编号" autocomplete="off" value='<c:if test="${not empty driver.jobNum}">${fn:substring(driver.jobNum,3,7)}</c:if>' class="layui-input" type="text">
				</div>
				<label class="layui-form-label">手机号码:</label>
				<div class="layui-input-inline">
					<input style="border:none; " disabled= "true" type="text" name="phone" id="phone" value="${driver.phone}" lay-verify="phone" placeholder="手机号码" autocomplete="off" class="layui-input">
				</div>
			</div>
		</div>
		<div class="layui-form-item">
			<div class="layui-inline">
				...
				<div class="layui-input-inline" style="width: 200px;">      
					<input style="border:none; " disabled= "true"  type="text" name="idCard" id="idCard" value="${driver.idCard}" lay-verify="required<c:if test='${empty driver.id}'>|idCardUnique</c:if>" placeholder="身份证号" autocomplete="off" class="layui-input"/>
				</div>
				<div class="layui-input-inline">
					...
					<div class="upload">
						<i class="icon-zoom-in zheng_a" onclick="fun_zheng(document.getElementById('idCardProsImg'));"></i>
					...
					<div class="upload">
						<i class="icon-zoom-in zheng_a" onclick="fun_zheng(document.getElementById('idCardConsImg'));"></i>
					</div>
				</div>
			</div>
		</div>
		<div class="layui-form-item">
			<div class="layui-inline">
				...
				<div class="layui-input-inline" style="width: 100px;">      
					<input type="text" name="workLicenseEffect" id="workLicenseEffect" placeholder="生效日期" autocomplete="off" class="layui-input input_date"
			    ...
			    <div class="layui-input-inline" style="width: 100px;">
			    	<input type="text" name="workLicenseInvalid" id="workLicenseInvalid" placeholder="截止日期" autocomplete="off" class="layui-input input_date"
				...
				<div class="layui-input-inline">
					...
					<div class="upload">
						<i class="icon-zoom-in zheng_a" onclick="fun_zheng(document.getElementById('workLicenseImg'));"></i>
		...
		<div class="layui-form-item">
			<div class="layui-inline">
				...
				<div class="layui-input-inline">
					...
					<div class="upload">
						<i class="icon-zoom-in zheng_a" onclick="fun_zheng(document.getElementById('drivingLicenseImg'));"></i>
