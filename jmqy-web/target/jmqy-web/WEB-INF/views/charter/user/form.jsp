...
<body class="window">
 <div class="layui-form" style="margin-top: 10px;">
	<form id="saveOrUpdate" class="layui-form" action="${ctx}/charter/user/saveOrUpdate" method="post" enctype="multipart/form-data">
		<input type="hidden" id="id" name="id" value="${user.id}"/>
		<div class="layui-form-item">
			<div class="layui-inline">
				<label class="layui-form-label">账号:</label>
				<div class="layui-input-inline">
					<input name="userAccount" lay-verify="required|userAccountUnique" autocomplete="off" value="${user.userAccount}" placeholder="账号" class="layui-input" type="text"
					<c:if test="${not empty user.id}">disabled</c:if>>
				</div>
				<label class="layui-form-label">用户名:</label>
				<div class="layui-input-inline">
					<input id="username" name="userName" lay-verify="required" autocomplete="off" value="${user.userName}" placeholder="用户名" class="layui-input" type="text" onchange="checkName(this.value);">
				</div>
			</div>
		</div>
		<div class="layui-form-item" pane="">
	  	...
	  	<div class="layui-form-item">
			<div class="layui-inline">
				...
				<div class="layui-input-inline">
					<input id="phone" name="phone" lay-verify="required" autocomplete="off" value="${user.phone}" lay-verify="required|phone|checkPhone" onchange="phone(this.value);" placeholder="手机号码" class="layui-input" type="text">
				</div>
