...
public class DateEditorUtils extends PropertyEditorSupport {
    ...
    public DateEditorUtils() {
    }

    public DateEditorUtils(DateFormat dateFormat) {
        this.dateFormat = dateFormat;
    }

    public DateEditorUtils(DateFormat dateFormat, boolean allowEmpty) {
        this.dateFormat = dateFormat;
