...
public class JpushClientUtil {
    ...
    private final static String appKey = "f821fcf286402664a6cab126";
 
    private final static String masterSecret = "e2beee8b67d5c802614db362";
     ...
     * @return 0推送失败，1推送成功
     */
    public static int sendToAll(String tag, String notification_title, String msg_title, String msg_content, String extrasparam) {
        int result = 0;
        try {
            PushPayload pushPayload= JpushClientUtil.buildPushObject_android_and_ios(tag,notification_title,msg_title,msg_content,extrasparam);
    ...
    public static PushPayload buildPushObject_android_and_ios(String tag, String notification_title, String msg_title, String msg_content, String extrasparam) {
    ...
    public static void main(String[] args){
    	try{
            ...
            //  13711223344
            // 13711552527
    		if(JpushClientUtil.sendToAll("13711223344", "您有新的任务","您有新的任务","this is a ios Dev 22222","1,DH-201803191509022_85")==1){
